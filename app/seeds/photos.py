...
def seed_photos():
    ...
    image3 = Photo(
        user_id=1, gallery_id=1, taken_date= datetime.strptime('2011-03-07','%Y-%m-%d'), upload_id=3, category='Travel', camera_type='Sony Alpha a7R III', lense_type='E 18-135mm F3.5-5.6 OSS', privacy='Public', title='Tunnel to Petra', description='The ancient city of petra', location='Petra, Jordan')
    image4 = Photo(
    ...
    image5 = Photo(
        user_id=1, gallery_id=1, taken_date= datetime.strptime('2019-10-09','%Y-%m-%d'), upload_id=5, category='Travel', camera_type='Sony Alpha a7R III', lense_type='Sony FE 24-70mm f/2.8 GM', privacy='Public', title='Wadi Rum', description='Wadi Rum desert in Jordan', location='Wadi Rum, Jordan')
    image6 = Photo(
    ...
    image16 = Photo(
        user_id=1, gallery_id=3, taken_date= datetime.strptime('2018-10-05','%Y-%m-%d'), upload_id=16, category='Travel', camera_type='Sony Alpha a7R III', lense_type='Sony FE 24-70mm f/2.8 GM', privacy='Public', title='Rice Farmer', description='Heading home after a hard days work.', location='Tam Coc Valley, Vietnam')
    image17 = Photo(
    ...
    image21 = Photo(
        user_id=2, gallery_id=2, taken_date= datetime.strptime('2020-05-24','%Y-%m-%d'), upload_id=21, category='City & Architecture', camera_type='Canon EOS 5D Mark II', lense_type='Canon EF 50mm f/1.8 II', privacy='Public', title='Through the Fence', location='NY, New York, USA')
    image22 = Photo(
        user_id=2, gallery_id=2, taken_date= datetime.strptime('2022-09-09','%Y-%m-%d'), upload_id=22, category='City & Architecture', camera_type='Canon EOS 5D Mark II', lense_type='Canon EF 50mm f/1.8 II', privacy='Public', title='Street Lights', description='Light reflections after a rainy day', location='NY, New York, USA')
    image23 = Photo(
        user_id=2, gallery_id=2, taken_date= datetime.strptime('2022-09-09','%Y-%m-%d'), upload_id=23, category='City & Architecture', camera_type='Sony A200', lense_type='18-70mm', privacy='Public', title='Moody Day', location='Tokyo, Japan')
    image24 = Photo(
        user_id=2, gallery_id=2, taken_date= datetime.strptime('2022-07-04','%Y-%m-%d'), upload_id=24, category='City & Architecture', camera_type='Sony A200', lense_type='18-70mm', privacy='Public', title='Tokyo Crosswalk', location='Tokyo, Japan')
    image25 = Photo(
        user_id=2, gallery_id=2, taken_date= datetime.strptime('2022-07-09','%Y-%m-%d'), upload_id=25, category='City & Architecture', camera_type='Sony A200', lense_type='18-70mm', privacy='Public', title='Cars on Cars', location='Tokyo, Japan')
    image26 = Photo(
        user_id=2, gallery_id=2, taken_date= datetime.strptime('2022-07-09','%Y-%m-%d'), upload_id=26, category='City & Architecture', camera_type='Sony A200', lense_type='18-70mm', privacy='Public', title='Woman Walking', location='Tokyo, Japan')
    image27 = Photo(
        user_id=2, gallery_id=2, taken_date= datetime.strptime('2022-06-09','%Y-%m-%d'), upload_id=27, category='City & Architecture', camera_type='Sony A200', lense_type='18-70mm', privacy='Public', title='Foggy Flatiron', location='NY, New York, USA')
    image28 = Photo(
        user_id=3, gallery_id=4, taken_date= datetime.strptime('2023-02-20','%Y-%m-%d'), upload_id=28, category='Portrait', camera_type='Canon EOS 5D Mark II', lense_type='Canon EF 50mm f/1.8 II', privacy='Public', title='Black & White Portrait', location='Los Angeles, California, USA')
    image29 = Photo(
        user_id=3, gallery_id=4, taken_date= datetime.strptime('2023-02-21','%Y-%m-%d'), upload_id=29, category='Black and White', camera_type='Canon EOS 5D Mark II', lense_type='Canon EF 50mm f/1.8 II', privacy='Public', title='Portrait of a girl', location='San Francisco, California, USA')
    image30 = Photo(
        user_id=3, gallery_id=4, taken_date= datetime.strptime('2023-02-21','%Y-%m-%d'), upload_id=30, category='Portrait', camera_type='Canon EOS 5D Mark II', lense_type='Canon EF 50mm f/1.8 II', privacy='Public', title='Man with Hat', location='Chicago, Illinois, USA')
    image31 = Photo(
        user_id=3, gallery_id=4, taken_date= datetime.strptime('2023-02-24','%Y-%m-%d'), upload_id=31, category='Portrait', camera_type='Canon EOS 5D Mark II', lense_type='Canon EF 50mm f/1.8 II', privacy='Public', title='Man with Flowers', location='Chicago, Illinois, USA')
    image32 = Photo(
        user_id=3, gallery_id=4, taken_date= datetime.strptime('2022-04-24','%Y-%m-%d'), upload_id=32, category='Portrait', camera_type='Canon EOS 5D Mark II', lense_type='Canon EF 50mm f/1.8 II', privacy='Public', title='Smoking Woman', location='Chicago, Illinois, USA')
    image33 = Photo(
        user_id=3, gallery_id=4, taken_date= datetime.strptime('2022-04-25','%Y-%m-%d'), upload_id=33, category='Portrait', camera_type='Canon EOS 5D Mark II', lense_type='Canon EF 50mm f/1.8 II', privacy='Public', title='Woman in Tulle', location='Chicago, Illinois, USA')
